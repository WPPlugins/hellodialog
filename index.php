...
class HelloDialogClass{
    ...
    function __construct() {
        ...
        if ( !class_exists( 'KBApi' ) ) {
            require_once( HD_PLUGIN_PATH . '/lib/KBApi.php' );
        }

        /**
         * Define WordPress actions.
         */
        ...
        /**
         * Define WordPress filters.
         */
        add_filter('widget_text','do_shortcode');

        /**
         * Run those actions only when WooCommerce is active.
         */
        ...
        function enqueue_js() {
            wp_enqueue_script( 'core', plugins_url('/hellodialog/assets/js/core.js') , array('jquery'), '1.0.1', false );
            wp_enqueue_script( 'bootstrap', plugins_url('/hellodialog/assets/js/bootstrap.min.js') , array('jquery'), '1.0.1', false );
        ...
        function hd_plugin_menu() {
            ...
            add_submenu_page( 'hellodialog-main', __('Fields', 'hellodialog'), __('Fields', 'hellodialog'), $role, 'hd-fields', 'hd_plugin_fields', 'dashicons-admin-generic', 10);
            add_submenu_page( 'hellodialog-main', __('Settings', 'hellodialog'), __('Settings', 'hellodialog'), $role, 'hd-settings', 'hd_plugin_settings', 'dashicons-admin-generic', 1);
        }

        function hd_plugin_fields() {
...
//                            echo esc_attr( get_option('success_string') );
...
//                            echo esc_attr( get_option('success_string') );
        ...
        function hd_meta_save($post_id, $post, $update){
            ...
            // Get form Title & Slogan
            if( isset ( $_POST['custom-meta-box2'] ) ) {
                // Get input & sanitize after
                $custom2   = $_POST['custom-meta-box2'];
                $old_meta2 = get_post_meta($post->ID, '_custom-meta-box2', true);
